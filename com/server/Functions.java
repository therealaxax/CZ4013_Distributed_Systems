...
public class Functions {
  ...
  public void checkFlightID(){
    ...
    for(Flight flight : flights){
      if(flight.getSource().equals(source) && flight.getDestination().equals(destination)){
        returnList.add(new AttributeValueInt("Flight Id", flight.getFlightIdentifier()));
      }
    }
  ...
  public void changeInvocation(){
    ...
    if(invocation == 1){
      ...
      returnList.add(new AttributeValueString("Success Message ", "Invocation successfully changed to AtLeastOnce"));
    }
    else if(invocation == 2){
      Main.isAtLeastOnce = false;
      returnList.add(new AttributeValueString("Success Message ", "Invocation successfully changed to AtMostOnce"));
    }
    else{
